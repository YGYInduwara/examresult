...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-100 shadow-sm flex flex-col lg:relative lg:shadow-none">
      {/* Logo */}
      <div className="px-6 py-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-slate-900 text-sm leading-tight">A/L Tracker</div>
            <div className="text-xs text-slate-400">Past Paper Manager</div>
          </div>
        </div>
      </div>

...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      else setError('Registration succeeded but login failed. Please sign in.')
    } catch {
    ...
    <div className="min-h-screen bg-linear-to-br from-violet-50 via-indigo-50 to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1 text-sm">Start tracking your A/L past paper journey</p>
        </div>
